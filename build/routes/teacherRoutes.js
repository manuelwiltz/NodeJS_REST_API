...
router.route('/server/api/rest/teacher/findall').get(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    var _a, _b;
...
router.get('/teacher1', function (req, res) {
    if (req.query.name) {
...
router.get('/teacher/:name', function (req, res) {
